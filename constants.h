...
const char ENEMY_LASER[] =     "..\\games_project_2\\pictures\\red laser2.png";      // menu texture
const char PLAYER_LASER[] =     "..\\games_project_2\\pictures\\blue laser2.png";      // menu texture
